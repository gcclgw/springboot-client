				...
				<form id="registerForm"  novalidate="novalidate" >
					<table>
						...
						<tr>
							...
							<td>
								<input type="password" onblur="checkpassword()" id="password" name="password" class="text" maxlength="20" autocomplete="off"/>
								<span></span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input id="repassword" onblur="checkrepassword()" type="password" name="repassword" class="text" maxlength="20" autocomplete="off"/>
							</td>
						</tr>
						<tr>
							<th>
