	...
	<div class="row">
	  	...
	  	<div class="col-md-9">
				...
				<div class="tab-content">
				   ...
				   <!--  ------------------------------------------------ -->
	<div class="panel-body" style="background:url('/');background-size:100%;height:200px;"></div>
...
$(function (){
	 $.ajax({
         type: "post",
         url: "<%=request.getContextPath()%>/orders/queryTree",
         data: null,
         dataType: "text",
         ...
         error: function(XMLHttpRequest, textStatus, errorThrown) {
             alert(XMLHttpRequest.status+"11111");
             alert(XMLHttpRequest.readyState+"2222");
             alert(textStatus+"3333");
               }
     });
